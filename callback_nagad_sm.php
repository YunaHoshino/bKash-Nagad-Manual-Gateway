<?php
/**
 * Nagad Send Money – Callback / Payment Notification Handler
 *
 * Place this file in: /modules/gateways/callback/nagad_sm.php
 *
 * @version 2.0.0
 */
...
// ── Identify gateway ─────────────────────────────────────────────────────────
$gatewayModuleName = basename(__FILE__, '.php');         // "nagad_sm"
...
$txnNote = "Nagad Send Money | TxnID: {$transactionId} | Sender: {$senderNumber}";
if ($note) {
    $txnNote .= " | Note: {$note}";
}
